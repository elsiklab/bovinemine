...
/**
 * A converter/retriever for the AmelNoncoding dataset via GFF files.
 */

public class AmelNoncodingGFF3RecordHandler extends GFF3RecordHandler
{

    /**
     * Create a new AmelNoncodingGFF3RecordHandler for the given data model.
     * @param model the model for which items will be created
     */
    public AmelNoncodingGFF3RecordHandler (Model model) {
        super(model);
